...
<template>
  <div class="bg-white rounded-lg shadow-md p-6 animate-fade-in">
    ...
    <div class="text-center mb-8">
      <div 
        class="w-40 h-40 rounded-full flex items-center justify-center mx-auto mb-6 text-4xl font-bold text-white shadow-lg"
        :class="{
          'bg-green-500': passed,
          'bg-red-500': !passed
        }"
      ...
      <div class="space-y-6 max-h-96 overflow-y-auto pr-2">
        ...
        >
          ...
          <div 
            ...
            class="p-3 rounded-md bg-green-50 border border-green-100 text-green-800"
          >
          ...
          <div 
            ...
            class="mt-3 p-3 bg-yellow-50 border-l-4 border-yellow-400 text-yellow-700 rounded-r"
          >
    ...
    <div v-if="studyRecommendations.totalIncorrect > 0" class="mb-8">
      <h3 class="text-xl font-semibold text-gray-800 mb-4 pb-2 border-b border-gray-200">
        📚 Áreas de mejora
      </h3>
      ...
      <div class="mb-6">
        <h4 class="font-semibold text-gray-700 mb-3">Bloques a reforzar:</h4>
        <div class="space-y-2">
          <div 
      ...
      <!-- Temas específicos -->
      <div>
        <h4 class="font-semibold text-gray-700 mb-3">Temas específicos a repasar:</h4>
        <div class="space-y-2">
          <div 
          ...
          >
            <div>
              ...
              <div class="text-sm text-gray-600">{{ topic.block }}</div>
            </div>
    ...
    <div v-else class="mb-8 bg-green-50 border-l-4 border-green-500 p-4 rounded-r">
    ...
    <button
      class="w-full py-3 px-6 bg-blue-600 text-white font-semibold rounded-lg shadow-md hover:bg-blue-700 transition-colors duration-200"
      @click="handleRestart"
    >
